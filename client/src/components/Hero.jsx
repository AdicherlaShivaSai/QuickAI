  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      <div className='text-center mb-6'>
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg  2xl:max-2-xl m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tool. Write articles, generate images and enhance your workflow.</p>
      </div>

      <div className='flex flex-wrap gap-4 text-sm max-sm:text-xs justify-center'>
      ...
      <div className='flex items-center gap-4 text-gray-600 text-sm justify-center mt-8'>
