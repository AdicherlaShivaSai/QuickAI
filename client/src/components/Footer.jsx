    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Experience the future of content creation with QuickAI.<br/> Our cutting-edge AI tools empower you to craft compelling articles, generate stunning images, and streamline your workflow like never before.
            </p>
        </div>
        <div className="flex-1 flex items-start md:justify-end gap-20">
            <div>
                <h2 classNameName="font-semibold mb-5 text-gray-800">Company</h2>
